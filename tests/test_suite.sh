...
"test24:$BUILDDIR/excogito optimize_kl -p ../files/parameters/parameters_optimizekl_6d93_N31_notemp.ini -t ../files/trajectories/6d93_100frames.xyz -r ../files/probabilities/6d93_probs_100frames.txt -c 6d93"
"test25:$BUILDDIR/excogito measure_kl -p ../files/parameters/parameters_measurekl_6d93_N31.ini -t ../files/trajectories/6d93_100frames.xyz -r ../files/probabilities/6d93_probs_100frames.txt -c 6d93 -m ../files/mappings/tamapin_ca_mapping.txt"
"test26:$BUILDDIR/excogito random_kl -p ../files/parameters/parameters_randomkl_6d93_N31.ini -t ../files/trajectories/6d93_100frames.xyz -r ../files/probabilities/6d93_probs_100frames.txt -c 6d93"
"test27:$BUILDDIR/excogito optimize_spins -p ../files/parameters/parameters_spins.ini -t ../files/trajectories/spins.csv -r ../files/probabilities/spins_probabilities.txt -c spin"
)
